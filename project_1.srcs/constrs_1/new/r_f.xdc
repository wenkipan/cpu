...
set_property PACKAGE_PIN R1 [get_ports {M[4]}]
set_property PACKAGE_PIN P2 [get_ports {M[3]}]
set_property PACKAGE_PIN P1 [get_ports {M[2]}]
set_property PACKAGE_PIN N2 [get_ports {M[1]}]
set_property PACKAGE_PIN M1 [get_ports {M[0]}]

set_property IOSTANDARD LVCMOS18 [get_ports Error1]
set_property PACKAGE_PIN K1 [get_ports Error1]
set_property IOSTANDARD LVCMOS18 [get_ports Error2]
set_property PACKAGE_PIN J1 [get_ports Error2]
